...
//      }
  ...
  xypic.Shape.CircleSegmentShape = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      svg.createSVGElement("path", {
        d:"M" + em2px(this.sx) + "," + em2px(-this.sy) + " A" + em2px(this.r) + "," + em2px(this.r) + " 0 " + this.large + "," + this.flip + " " + em2px(this.ex) + "," + em2px(-this.ey)
      });
    },
    getBoundingBox: function () {
  ...
  xypic.Shape.FullCircleShape = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      svg.createSVGElement("circle", {
        cx:em2px(this.x), cy:em2px(-this.y), r:em2px(this.r)
      });
    },
    getBoundingBox: function () {
      return xypic.Frame.Ellipse(this.x, this.y, this.r, this.r, this.r, this.r);
  ...
  xypic.Shape.RectangleShape = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      var def;
      def = {
        x:em2px(this.x - this.left), 
        y:-em2px(this.y + this.up), 
        width:em2px(this.left + this.right), 
        height:em2px(this.up + this.down), 
        rx:em2px(this.r)
      };
      ...
      if (this.isDoubled) {
        def = {
          x:em2px(this.x - this.left + AST.xypic.thickness), 
          y:-em2px(this.y + this.up - AST.xypic.thickness), 
          width:em2px(this.left + this.right - 2 * AST.xypic.thickness), 
          height:em2px(this.up + this.down - 2 * AST.xypic.thickness), 
          rx:em2px(Math.max(this.r - AST.xypic.thickness, 0))
        };
        if (this.dasharray !== undefined) {
          def["stroke-dasharray"] = this.dasharray;
        }
    ...
    draw: function (svg) {
      ...
      if (this.isDoubled) {
        def = {
          cx:em2px(this.x), 
          cy:-em2px(this.y), 
          rx:em2px(Math.max(this.rx - AST.xypic.thickness)), 
          ry:em2px(Math.max(this.ry - AST.xypic.thickness))
        };
        if (this.dasharray !== undefined) {
          def["stroke-dasharray"] = this.dasharray;
        }
  ...
  xypic.Shape.BoxShadeShape = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      var x = em2px(this.x);
      var y = em2px(this.y);
      var l = em2px(this.left);
      var r = em2px(this.right);
      var u = em2px(this.up);
      var d = em2px(this.down);
      var depth = em2px(this.depth);
      svg.createSVGElement("path", {
        d: "M" + (x - l + depth) + "," + (-y + d) + 
          "L" + (x + r) + "," + (-y + d) + 
          "L" + (x + r) + "," + (-y - u + depth) + 
...
*/
  ...
  xypic.Shape.GTArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:0.55, r:0, d:0.165, u:0.165 },
    drawDelegate: function (svg) {
      svg.createSVGElement("path", {
        d:"M0,0 Q" + em2px(-0.25) + "," + em2px(0.023) + " " + em2px(-0.55) + "," + em2px(0.165)
      });
  ...
  xypic.Shape.LTArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:0, r:0.55, d:0.165, u:0.165 }, 
    drawDelegate: function (svg) {
      svg.createSVGElement("path", {
        d:"M0,0 Q" + em2px(0.25) + "," + em2px(-0.023) + " " + em2px(0.55) + "," + em2px(-0.165)
      });
  ...
  xypic.Shape.AsteriskArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:AST.xypic.thickness, r:AST.xypic.thickness, u:AST.xypic.thickness, d:AST.xypic.thickness }, 
    drawDelegate: function (svg) {
      svg.createSVGElement("circle", {
        cx:0, cy:0, r:em2px(AST.xypic.thickness),
        fill: "currentColor"
      });
    }
  });
  ...
  xypic.Shape.SlashArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:0, r:0, u:AST.xypic.lineElementLength / 2, d:AST.xypic.lineElementLength / 2 }, 
    drawDelegate: function (svg) {
      var halfLen = AST.xypic.lineElementLength / 2;
      var halfLenPx = em2px(halfLen);
      svg.createSVGElement("line", {
  ...
  xypic.Shape.Line3ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:0, r:AST.xypic.lineElementLength, u:AST.xypic.thickness, d:AST.xypic.thickness }, 
    drawDelegate: function (svg) {
      var lineLen = em2px(AST.xypic.lineElementLength);
      var vshift = em2px(AST.xypic.thickness);
      svg.createSVGElement("line", {
  ...
  xypic.Shape.Line2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:0, r:AST.xypic.lineElementLength, u:0.5 * AST.xypic.thickness, d:0.5 * AST.xypic.thickness }, 
    drawDelegate: function (svg) {
  ...
  xypic.Shape.LineArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:0, r:AST.xypic.lineElementLength, u:0, d:0 }, 
    drawDelegate: function (svg) {
      var lineLen = em2px(AST.xypic.lineElementLength);
      svg.createSVGElement("line", {
        x1:0, y1:0, x2:lineLen, y2:0
  ...
  xypic.Shape.Dot3ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:0, r:0, u:AST.xypic.thickness, d:AST.xypic.thickness }, 
    drawDelegate: function (svg) {
      var vshift = em2px(AST.xypic.thickness);
      var lineLen = em2px(AST.xypic.thickness);
  ...
  xypic.Shape.Dot2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:0, r:0, u:0.5 * AST.xypic.thickness, d:0.5 * AST.xypic.thickness }, 
    drawDelegate: function (svg) {
      var vshift = em2px(0.5 * AST.xypic.thickness);
      var lineLen = em2px(AST.xypic.thickness);
      var dasharray = "1 " + lineLen;
  ...
  xypic.Shape.Tilde3ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:-2 * AST.xypic.thickness, r:2 * AST.xypic.thickness, u:2 * AST.xypic.thickness, d:2* AST.xypic.thickness }, 
    drawDelegate: function (svg) {
  ...
  xypic.Shape.Tilde2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    box: { l:-2 * AST.xypic.thickness, r:2 * AST.xypic.thickness, u:1.5 * AST.xypic.thickness, d:1.5 * AST.xypic.thickness }, 
    drawDelegate: function (svg) {
      var s = em2px(AST.xypic.thickness);
      svg.createSVGElement("path", {
        d:"M" + (-2 * s) + "," + (0.5 * s) + 
    ...
    _drawLine: function (svg, object, main, variant) {
      ...
      if (s.x !== e.x || s.y !== e.y) {
        ...
        switch (main) {
          ...
          case '.':
          case '..':
            this.drawStraightLine(svg, s, e, shift, angle, t, variant, "1 " + em2px(t));
            break;
          case ':':
          case '::':
            this.drawStraightLine(svg, s, e, shift, angle, t, "2", "1 " + em2px(t));
            break;
          case '--':
          case '==':
            var len = Math.sqrt(dx * dx + dy * dy);
            ...
            if (len >= dash) {
              ...
              this.drawStraightLine(svg, s, e, shift, angle, t, (main === "=="? "2" : variant), em2px(dash) + " " + em2px(dash));
            }
            break;
          case '~':
            var len = Math.sqrt(dx * dx + dy * dy);
...
//        })
  ...
  AST.Command.Xymatrix.Augment({
    toShape: function (context) {
      ...
      // TODO envをduplicateし、xymatrixが入れ子になってもいいようにする。
      
      env.xymatrixPrefix = "";
      env.xymatrixRowSepEm = HTMLCSS.length2em("2pc");
      env.xymatrixColSepEm = HTMLCSS.length2em("2pc");
      env.xymatrixPretendEntryHeight = FP.Option.empty;
      env.xymatrixPretendEntryWidth = FP.Option.empty;
      env.xymatrixFixedRow = false;
      env.xymatrixFixedCol = false;
      env.xymatrixOrientationAngle = 0;
      env.xymatrixEntryModifiers = FP.List.empty;
      
      this.setup.foreach(function (sw) { sw.toShape(context); });
      ...
      var matrix = xypic.Xymatrix(
        this.rows.map(function (row) {
          rownum += 1;
          colnum = 0;
          return xypic.Xymatrix.Row(
            row.entries.map(function (entry) {
              colnum += 1;
              var localEnv = env.duplicate();
              ...
              return xypic.Xymatrix.Entry(shape, entry.decor, localEnv.c);
            })
          )
      ...
      var rowsep = env.xymatrixRowSepEm;
      var colsep = env.xymatrixColSepEm;
      ...
      matrix.rows.foreach(function (row) {
        colIndex = 0;
        row.entries.foreach (function (entry) {
          var objectShape = xypic.Shape.TranslateShape(xs[colIndex], ys[rowIndex], entry.objectShape);
          context.appendShapeToFront(objectShape);
          colIndex += 1;
        });
        rowIndex += 1;
      ...
      //this.rows.foreach(function (sw) { sw.toShape(context); });
    }
  });
  ...
  xypic.Xymatrix = MathJax.Object.Subclass({
    ...
    getColumn: function (colnum /* >= 1 */) {
      if (this.columns.length() >= colnum) {
        ...
        var column = xypic.Xymatrix.Column();
  ...
  xypic.Xymatrix.Row = MathJax.Object.Subclass({
    ...
    getU: function () {
      var maxU = 0;
      this.entries.foreach(function (e) { maxU = Math.max(maxU, e.getU()); })
      return maxU;
    },
    getD: function () {
      var maxD = 0;
      this.entries.foreach(function (e) { maxD = Math.max(maxD, e.getD()); })
      return maxD;
    },
    toString: function () {
      return this.entries.mkString(" & ");
  ...
  xypic.Xymatrix.Column = MathJax.Object.Subclass({
    ...
    getL: function () {
      var maxL = 0;
      this.entries.foreach(function (e) { maxL = Math.max(maxL, e.getL()); })
      return maxL;
    },
    getR: function () {
      var maxR = 0;
      this.entries.foreach(function (e) { maxR = Math.max(maxR, e.getR()); })
      return maxR;
    },
    toString: function () {
      return this.entries.mkString(" \\\\ ");
  ...
  xypic.Xymatrix.Entry = MathJax.Object.Subclass({
    Init: function (objectShape, decor, frame) {
  ...
  AST.Command.Xymatrix.Setup.PretendEntrySize.Height.Augment({
    toShape: function (context) {
      context.env.xymatrixPretendEntryHeight = FP.Option.Some(this.dimen);
    }
  });
  
  AST.Command.Xymatrix.Setup.PretendEntrySize.Width.Augment({
    toShape: function (context) {
      context.env.xymatrixPretendEntryWidth = FP.Option.Some(this.dimen);
    }
  });
  
  AST.Command.Xymatrix.Setup.PretendEntrySize.HeightAndWidth.Augment({
    toShape: function (context) {
      var len = FP.Option.Some(this.dimen);
